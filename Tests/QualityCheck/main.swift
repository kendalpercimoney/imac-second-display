...
func trial(_ label: String, bitrate: Int, keyframeInterval: Double,
    ...
    let encoder = VideoEncoder(config: .init(
        ...
        dataRateLimitMultiplier: dataRateLimitMultiplier)) { sampleBuffer in
...
print("\nZooming into a detailed image at \(width)x\(height)/\(fps), 25 Mb/s unless stated\n")
trial("shipped in v1.2.0", bitrate: 25_000_000, keyframeInterval: 5.0,
      prioritizeSpeed: true, dataRateLimitMultiplier: 2.0)
trial("without PrioritizeEncodingSpeedOverQuality", bitrate: 25_000_000, keyframeInterval: 5.0,
      prioritizeSpeed: false, dataRateLimitMultiplier: 2.0)
trial("...and a looser burst cap (4x)", bitrate: 25_000_000, keyframeInterval: 5.0,
      prioritizeSpeed: false, dataRateLimitMultiplier: 4.0)
trial("...and no burst cap at all", bitrate: 25_000_000, keyframeInterval: 5.0,
      prioritizeSpeed: false, dataRateLimitMultiplier: nil)
trial("keyframe 2s instead of 5s (otherwise as shipped)", bitrate: 25_000_000,
      keyframeInterval: 2.0, prioritizeSpeed: true, dataRateLimitMultiplier: 2.0)
trial("fixed + 40 Mb/s", bitrate: 40_000_000, keyframeInterval: 5.0,
      prioritizeSpeed: false, dataRateLimitMultiplier: 4.0)
